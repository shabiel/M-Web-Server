%WINIT ; ; 02-MAY-2013
 ...
 S DIOVRD=1,U="^",DIFQ=0,DIFROM="0.1" W !,"This version (#0.1) of '%WINIT' was created on 02-MAY-2013"
 W !?9,"(at Vista-Office EHR, by VA FILEMAN 22.2)",!
...
EN ; ENTER HERE TO BYPASS THE PRE-INIT PROGRAM
 ...
 S DIFROM="0.1" D PKG:'$D(DIFROM(0)),^%WINIT1 G Q:'$D(DIFQ) S DIK(0)="AB"
